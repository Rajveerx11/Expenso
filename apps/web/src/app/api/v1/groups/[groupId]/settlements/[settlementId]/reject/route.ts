...
import { rejectSettlement } from '@/server/settlements/settlement-service';
...
export async function POST(request: Request, context: Context) {
  ...
  try {
    ...
    const settlement = await rejectSettlement(client, uuidSchema.parse(params.groupId), uuidSchema.parse(params.settlementId));
